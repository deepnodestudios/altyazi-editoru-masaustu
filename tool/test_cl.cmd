...
set TMP_CPP=%TEMP%\copilot_test_ucrt.cpp
echo int main(){return 0;} > "%TMP_CPP%"
cl /nologo /EHsc "%TMP_CPP%" /Fe:"%TEMP%\copilot_test_ucrt.exe"
set EXITCODE=%ERRORLEVEL%
del "%TMP_CPP%" >nul 2>nul
if exist "%TEMP%\copilot_test_ucrt.obj" del "%TEMP%\copilot_test_ucrt.obj" >nul 2>nul
exit /b %EXITCODE%
